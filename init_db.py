...
from database_setup import db, Venue, Artist, Genre, Shows
...
with app.app_context():
    ...
    event1 = Shows(start_time='2019-05-21T21:30:00.000Z', venues=venue1, artists=artist1)    
    event2 = Shows(start_time='2019-06-15T23:00:00.000Z', venues=venue3, artists=artist2)    
    event3 = Shows(start_time='2035-04-01T20:00:00.000Z', venues=venue3, artists=artist3)    
    event4 = Shows(start_time='2035-04-08T20:00:00.000Z', venues=venue3, artists=artist3)    
    event5 = Shows(start_time='2035-04-015T20:00:00.000Z', venues=venue3, artists=artist3)
